      ...
      for (SLONG c=0; c<pBlock->Table.AnzRows; c++)
         if (pBlock->Table.LineIndex[c]==PostSelected)
         {
            ...
            if (bFullscreen)
            {
               ...
               if (IsLaptop) SetCursorPos (pBlock->ScreenPos.x+48+90-40, pBlock->ScreenPos.y+72+13-50+cy);
               else          SetCursorPos (pBlock->ScreenPos.x+104+90-40-21, pBlock->ScreenPos.y+195+13-50-76+cy);
            }
   ...
   if (pBlock)
   {
      ...
      for (SLONG c=0; c<pBlock->TableB.AnzRows; c++)
         if (pBlock->TableB.LineIndex[c]==PostSelected)
         {
            ...
            if (bFullscreen)
            {
               if (IsLaptop) SetCursorPos (pBlock->ScreenPos.x+232+48+48+15-40, pBlock->ScreenPos.y+72+13-50+26*(c-pBlock->Page));
               else          SetCursorPos (pBlock->ScreenPos.x+232+104+48+90-40-48-21, pBlock->ScreenPos.y+195+13-50-80+26*(c-pBlock->Page));
            }
